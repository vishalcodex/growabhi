...
<div class="form-group">
    ...
    <div class="input-group">
        <div class="custom-file">
            <input type="file" class="custom-file-input" id="video_file_for_wasabi_storage" name="video_file_for_wasabi_storage" onchange="changeTitleOfImageUploader(this)">
...
<div class="form-group">
    ...
    <input type="text" class="form-control" data-toggle='timepicker' data-minute-step="5" name="wasabi_duration" id = "wasabi_duration" data-show-meridian="false" value="<?php echo $lesson_details['duration']; ?>" required>
</div>
